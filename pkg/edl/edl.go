...
Миссия: Вызволить VIP находящегося на территории частной коммерческой организации на планете Magen (С543550-9).
...
Оплата: 20000 Cr каждому участнику перед началом миссии. 50000 Сr каждому при доставке VIP'а к заказчику.
Комментарии: Наёмный отряд будет снабжен экипировкой, транспортом и актуальными тактическими данными. Лишние вопросы не приветствуются.
*/
