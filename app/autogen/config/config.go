...
type configuration struct {
	...
	LogPath         string          `yaml:"Log File Path"`                             //where log is written
}
...
//GetLogFilePath - autogenerated getter for 'Log File Path' option of config file
func (cfg *configuration) LogFilePath() string {
	return cfg.LogPath
}
