...
func main() {
	...
	for scanner.Scan() {
		...
		args = append(args, fmt.Sprintf(`-i %v -vf drawtext=textfile=d:\\tests\\text1.txt:fontcolor=orange:fontsize=150:x=((w/5)*3):y=((h/100)*85):,drawtext=textfile=d:\\tests\\text1.txt:fontcolor=orange:fontsize=150:x=((w/5)*3):y=((h/100)*85)+160: -y %v`, input, output))
